...
reports and JSON exports. No sqlglot transpilation — native
    ...
    *,
    ...
    Args:
        ...
        format_for_compare: When True, applies textual normalization for stable
            line-by-line display: rstrips each line, collapses runs of blank
...
def _format_for_compare(sql: str) -> str:
    """Textual normalization for stable display. No SQL transpilation."""
    if not sql:
        return ""
