...
class Synonym(SqlObject):
    ...
    def create_statement(self) -> str:
        ...
        try:
            ...
            # Fallback to basic CREATE SYNONYM if generator not available
            return self._generate_basic_create_statement()

    def _generate_basic_create_statement(self) -> str:
        """Generate a basic CREATE SYNONYM statement as fallback.
        ...
        keyword = quirks.synonym_keyword
        prefix = "CREATE OR REPLACE" if quirks.synonym_supports_create_or_replace else "CREATE"
        stmt = f"{prefix} {keyword} {schema_prefix}{synonym_name}"
