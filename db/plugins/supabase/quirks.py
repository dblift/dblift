"""Supabase (PostgreSQL) :class:`DialectQuirks` — inherits PostgreSQL behavior."""
...
class SupabaseQuirks(PostgresqlQuirks):
    """Supabase (PostgreSQL) quirks, inheriting every PostgreSQL quirk.

    Supabase (PostgreSQL) speaks the PostgreSQL wire protocol, so statement splitting,
    ...
    def __init__(self, dialect_name: str = "supabase") -> None:
        super().__init__(dialect_name=dialect_name)


__all__ = ["SupabaseQuirks"]
