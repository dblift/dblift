"""YugabyteDB (PostgreSQL-compatible) :class:`DialectQuirks` — inherits PostgreSQL behavior."""
...
class YugabytedbQuirks(PostgresqlQuirks):
    """YugabyteDB (PostgreSQL-compatible) quirks, inheriting every PostgreSQL quirk.

    YugabyteDB (PostgreSQL-compatible) speaks the PostgreSQL wire protocol, so statement splitting,
    ...
    def __init__(self, dialect_name: str = "yugabytedb") -> None:
        super().__init__(dialect_name=dialect_name)


__all__ = ["YugabytedbQuirks"]
