...
class TestEventType:
    ...
    def test_snapshot_event_type_compat_members(self):
        ...
        assert EventType.SNAPSHOT_STARTED.value == "snapshot.started"
        assert EventType.SNAPSHOT_COMPLETED.value == "snapshot.completed"
        assert EventType.SNAPSHOT_LOADED.value == "snapshot.loaded"
        assert EventType.SNAPSHOT_SAVED.value == "snapshot.saved"
