"""
Neutral row-access helpers shared by runtime and introspection code.

This module intentionally avoids depending on the rich introspection package so
OSS runtime modules can use metadata row helpers without importing that namespace.
"""
