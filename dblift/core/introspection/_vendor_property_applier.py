...
Extracted from :class:`dblift.core.introspection.schema_introspector.SchemaIntrospector`
...
:meth:`dblift.db.base_quirks.BaseQuirks.apply_vendor_table_properties`; this
