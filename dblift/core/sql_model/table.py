...
# from the plugin registry via ``dblift.core.sql_model.table_options`` so this module
...
class Table(SqlObject):
    ...
    The legacy :class:`dblift.core.sql_model.table_options.TableOptions` typed
