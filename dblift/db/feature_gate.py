...
boolean capability flags on :class:`dblift.db.base_quirks.BaseQuirks`.
...
:func:`dblift.core.sql_model.feature_gates.supports_feature`. This module is a
stdlib-only leaf so ``dblift.db.base_quirks`` can import it without cycles.
"""
