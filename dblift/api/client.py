...
from dblift.api.events import EventEmitter, EventType, use_client_emitter
...
from dblift.db.provider_interfaces import ConnectionProvider, TransactionalProvider
...
class DBLiftClient:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        attach_registered_listeners(self.events)
    ...
    def _resolve_factory_client_cls(cls) -> type:
        ...
        (``dblift.core.seams.client_factory.resolve_client_class``) so a
