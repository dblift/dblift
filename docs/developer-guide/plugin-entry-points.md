...
Plugin code should import provider contracts, SQL-generation contracts, and
schema-model types from the stable extension surfaces, not from implementation
modules:
