...
class EventType(Enum):
    ...
    # Snapshot compatibility members retained for public API consumers.
    # P1.1 no longer emits automatic snapshot events from migration execution.
